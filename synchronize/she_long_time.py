...
# Solve the SHE with multiplicative noise for large times
...
def animate(i):
	...
	# Redefine the plot
	lines_a.set_data(space, she_sample.state_a)
	lines_b.set_data(space, she_sample.state_b)
...
ani.save(filename = 'double_she.mp4', extra_args=['-vcodec', 'libx264'], bitrate = 7000)
