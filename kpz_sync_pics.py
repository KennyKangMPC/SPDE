...
fig       = plt.figure()
ax        = plt.axes(xlim=(0, np.pi), ylim = (0, 2.0))
...
time_text.set_text("Time = {:2.3f}".format(0))

# We save the initial state of the plot.
plt.savefig("initial_state.jpg", format='jpg', dpi=1000)
...
# We save the final state of the plot.
plt.savefig("final_state.jpg", format='jpg', dpi=1000)
